...
const Home = () => {
  return(
      ...
      <div className="container-fluid">
          ...
          <div className="row row-content row_hanging_out d-flex align-items-center">
              <div className="col-6 col-md-3">
          ...
          <div className='row row-content'>
              <div className="col">
                <h1 className='text-center description_heading'>RELIABLE TECH FOR STAYING CLOSE</h1>
                ...
                <img src={fourth_img} alt="Reliable tech " width='678px' height='440px'/>
